...
func setTweetDetailUserInfoAttributes( _ name:String, _ userName:String, _ isVerified:Bool) -> NSAttributedString {
    let attributedText = NSMutableAttributedString(string:"\(name) " , attributes:[NSAttributedString.Key.font: UIFont(name: CustomFonts.appFontMedium, size: 17)!, NSAttributedString.Key.foregroundColor: UIColor.dynamicColor(.textColor)])
    ...
    attributedText.append(NSAttributedString(string: "\n@\(userName)" , attributes:[NSAttributedString.Key.font: UIFont(name: CustomFonts.appFont, size: 17)! , NSAttributedString.Key.foregroundColor: CustomColors.appDarkGray]))
