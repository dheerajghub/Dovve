//
//  TDPostWithImageAndQuotedImageCollectionViewCell.swift
//  Dovve
//
...
protocol TDPostWithImageAndQuotedImageDelegate{
    func didUserProfileTapped(for cell: TDPostWithImageAndQuotedImageCollectionViewCell, _ isQuotedUser:Bool , _ isRetweeted:Bool)
...
class TDPostWithImageAndQuotedImageCollectionViewCell: UICollectionViewCell {
    var data:TweetData?{
        didSet{
            manageData()
    ...
    var delegate:TDPostWithImageAndQuotedImageDelegate?
...
extension TDPostWithImageAndQuotedImageCollectionViewCell:UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
...
extension TDPostWithImageAndQuotedImageCollectionViewCell:QuotedActionProtocol {
